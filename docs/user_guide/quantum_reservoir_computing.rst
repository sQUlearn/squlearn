...
scaling dimension of the Hilbert space in the quantum computing context to prove a advantage over the 
classical RC. First the classical input data :math:`x=\lbrace x^{l}\rbrace_l` gets related to a unitary 
