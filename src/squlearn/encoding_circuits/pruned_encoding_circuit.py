...
class PrunedEncodingCircuit(EncodingCircuitBase):
    ...
    **Example: Pruned QEK Encoding Circuit**
    ...
    .. code-block:: python
        ...
        from squlearn.encoding_circuits import QEKEncodingCircuit,PrunedEncodingCircuit
...
def automated_pruning(
    ...
    Args:
        encoding_circuit (EncodingCircuitBase): Parameterized quantum circuit that will be pruned.
                                      Has to be in the encoding_circuits format of quantum_fit!
    ...
    Returns:
        Pruned encoding_circuits as a PrunedEncodingCircuit class object.
    """
    ...
    # Return pruned encoding_circuits
