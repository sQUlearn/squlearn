...
class QGPC(GaussianProcessClassifier):
    ...
    **Example**
    ...
    .. code-block::
        ...
        enc_circuit = QEKEncodingCircuit(num_qubits=X.shape[1], num_features=X.shape[1], num_layers=2)
        q_kernel = FidelityKernel(encoding_circuit=enc_circuit, executor=Executor("statevector_simulator"))
