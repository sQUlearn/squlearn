...
class FidelityKernel(KernelMatrixBase):
    ...
    Args:
        ...
        use_expectation (bool, default=False):
            ...
            :math:`U(x)^\dagger U(y) |0\rangle` and measures the expectation value of
            :math:`P_0 = |0\rangle\langle 0|^{\otimes n}`, where
            :math:`U(x)` is the encoding circuit unitary evaluated for data `x`.
